...
```{r count_data, echo=FALSE, fig.height=4, fig.width=6}
...
```{r method_C, echo=FALSE, fig.height=4, fig.width=6, warning=FALSE}
ggplot2::ggplot(
  data = count_data,
...
```{r compare, echo=FALSE, fig.height=4, fig.width=6}
ggplot2::ggplot() +
  ggplot2::geom_line(
    mapping = ggplot2::aes(
      y = c(0.6, 1.4),
...
-   Regression to the mean. As seen in the chart, the high average for 2008-2011 was followed by a
    ...
    identical to the all-year average before the rise (1983-2007).

```{r plot_full, echo=FALSE, fig.height=4, fig.width=6}
